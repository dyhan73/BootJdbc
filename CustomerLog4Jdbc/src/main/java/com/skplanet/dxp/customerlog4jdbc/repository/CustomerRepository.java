package com.skplanet.dxp.customerlog4jdbc.repository;

import com.skplanet.dxp.customerlog4jdbc.domain.Customer;
...
public class CustomerRepository {
    ...
    public Customer save(Customer customer) {
        ...
        if (customer.getId() == null) {
            ...
            jdbcTemplate.update("UPDATE customers SET first_name=:firstName, last_name=:lastName "
            + "WHERE id=:id", param);
        }
        return customer;
    }
